Fork of LARAVEL SHOP (minor changes for Laravel 5.6 Compatibility)
--------------------------------
...
Laravel Shop is flexible way to add shop functionality to **Laravel 5.6**. Aimed to be the e-commerce solution for artisans.
